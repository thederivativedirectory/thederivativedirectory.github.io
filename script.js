...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById("model-count-number").textContent = modelCards.length;
  const numberWords = [
    "Zero",
    "One",
    "Two",
  ...
  document.getElementById("model-count-text").textContent = numberWords[modelCards.length];

  const count = modelCards.length;

  document.getElementById("model-count").dataset.target = count;
